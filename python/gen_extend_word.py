...
def actualQE(queryList, K, L, topN, model):
    ...
    L = {array.tostring(): array for array in autualQueryExtend}
    autualQueryExtend = L.values()
...
def actualQEwith2_1(queryList, topN, model):
    ...
    finalQueryList = queryVectorList + integrateQueryList
    L = {array.tostring(): array for array in candidateWord}
    candidateWord = L.values()
